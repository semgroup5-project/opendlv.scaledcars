...
control/example/CMakeFiles/scaledcars-control-example.dir/apps/scaledcars-control-example.cpp.o: /opt/opendlv.scaledcars.sources/code/control/example/apps/scaledcars-control-example.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/opt/opendlv.scaledcars.build/build.system/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object control/example/CMakeFiles/scaledcars-control-example.dir/apps/scaledcars-control-example.cpp.o"
	cd /opt/opendlv.scaledcars.build/build.system/control/example && /usr/bin/c++   $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/scaledcars-control-example.dir/apps/scaledcars-control-example.cpp.o -c /opt/opendlv.scaledcars.sources/code/control/example/apps/scaledcars-control-example.cpp
...
control/example/CMakeFiles/scaledcars-control-example.dir/apps/scaledcars-control-example.cpp.i: cmake_force
	...
	cd /opt/opendlv.scaledcars.build/build.system/control/example && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /opt/opendlv.scaledcars.sources/code/control/example/apps/scaledcars-control-example.cpp > CMakeFiles/scaledcars-control-example.dir/apps/scaledcars-control-example.cpp.i
...
control/example/CMakeFiles/scaledcars-control-example.dir/apps/scaledcars-control-example.cpp.s: cmake_force
	...
	cd /opt/opendlv.scaledcars.build/build.system/control/example && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /opt/opendlv.scaledcars.sources/code/control/example/apps/scaledcars-control-example.cpp -o CMakeFiles/scaledcars-control-example.dir/apps/scaledcars-control-example.cpp.s
...
control/example/scaledcars-control-example: control/example/CMakeFiles/scaledcars-control-example.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/opt/opendlv.scaledcars.build/build.system/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable scaledcars-control-example"
	cd /opt/opendlv.scaledcars.build/build.system/control/example && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/scaledcars-control-example.dir/link.txt --verbose=$(VERBOSE)
...
control/example/CMakeFiles/scaledcars-control-example.dir/clean:
	cd /opt/opendlv.scaledcars.build/build.system/control/example && $(CMAKE_COMMAND) -P CMakeFiles/scaledcars-control-example.dir/cmake_clean.cmake
